...
'''
一正一负的// %计算公式：
（/是精确除法，//除法返回整数结果、%是求模）当俩个整数都为正数，python和其它语言的计算结果是一样的；当有一正一负的时，算法结果有差异
假设x和y有一个正数和负数
...
#看列子
# -18//4
#根据公式-4到18的距离为22，22//4等于5.5，再取整为5，加上运算符结果为-5
print(18//-4)   #打印结果为-5


#-16%3
#-16%3=|-16|-(|3|*|-16//3|)=16-3*6=-2     符号与y相同，所以结果等于2
print(-16%3)

#16%-3
#-16%3=|-16|-(|3|*|-16//3|)=16-3*6=-2     符号与y相同，所以结果等于-2
print(16%-3)
